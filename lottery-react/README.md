# `npm run start` will not work from this nested folder because of pathing
# must be in parent level where bootstrapped...

# BTW, web3 package management is shit right now... yarn or npm
# not getting it done.. :/
